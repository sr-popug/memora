...
export default function LinkBlock({
  ...
  return (
    <div className='bg-neutral-900 rounded-lg py-2 px-2 border-1 border-neutral-600 max-w-lg'>
        ...
        <Tooltip>
          ...
          {openGraphData && (
            <div className='flex gap-2'>
              ...
              <h3 className='mb-2 font-bold max'>
        ...
        <div className='min-w-40 flex justify-between gap-3 mt-2'>
          ...
          <div className='flex gap-2 align-center'>
            <NextLink
              ...
              target='_blank'
            >
              <Button className='cursor-pointer '>Перейти по ссылке</Button>
            </NextLink>
