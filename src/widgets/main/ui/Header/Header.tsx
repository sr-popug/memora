...
export default function Header() {
  return (
    <header className='border-b-neutral-600 border-b py-3 mb-2 px-2'>
      <div className='max-w-[1200px] mx-auto flex justify-between items-center gap-5'>
        ...
        <div className='buttons flex align-center gap-4'>
          ...
          <Link
            className='hidden lg:block py-2 px-10 font-semibold text-neutral-900 bg-gradient-to-l text- from-blue-500 to-blue-200 transition-colors rounded-3xl hover:to-blue-500'
            href={'/canvas'}
          >
            Регистрация
          </Link>
