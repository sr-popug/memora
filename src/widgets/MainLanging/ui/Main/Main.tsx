...
export default function Main() {
  return (
    <article className=' flex justify-center lg:justify-between gap-2 '>
      <section className='left'>
        ...
        <p className='text-[16px] mt-8 max-w-[450px]  text-center lg:text-left'>
      ...
      <section className='right hidden lg:block'>
        <Image src={'/main-image.svg'} alt={'main'} width={592} height={710} />
      </section>
    </article>
  )
}
